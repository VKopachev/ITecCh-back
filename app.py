...
def get_events():
    events = [
        {
            'logo_img': 'https://scontent.fkbp1-1.fna.fbcdn.net/v/t31.0-8/18891795_1449723381732456_3126740517817752314_o.png',
            'company_name': 'InterLink LLC',
            'fb_company_link': 'https://www.facebook.com/interlinkua/',
            'img_link': 'https://scontent.fkbp1-1.fna.fbcdn.net/v/t1.0-9/59305857_2301256683245784_6300423410677710848_n.jpg',
            'date': '26.05.19',
